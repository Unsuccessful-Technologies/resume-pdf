...
export default (content: ContentConfig) => {
    ...
    const {content:{ header:headerConfig, summary:summaryConfig, top_skills:topSkillsConfig, experience:experienceConfig, education:educationConfig}} = config
    let resume = new jsPDF({ unit: "in" })
